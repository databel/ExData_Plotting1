...
## Create and save PLOT 1 as plot1.png
png("./plot1.png")
hist(datapower2$Global_active_power, col = "red", main="Global Active Power", xlab="Global Active Power (kilowatts)", width = 480, height = 480, units = "px")
dev.off()
